...
struct NeighborGraph                      //Changed here
{
   singhop ss;
   TwoHopNeighborSet stc;
};
...
private:
  ...
  uint16_t m_TLV;   //Changed here (TLV type)
  ...
  void FormARoutingTable (const Ipv4Address &dest, const Ipv4Address &next, const Ipv4Address &interfaceAddress); //Changed here
  /**
  ...
  bool ComputeFloodingMPR (const Ipv4Address &senderAddress, const Ipv4Address &receiverAddress, olsr::MessageHeader olsrMessage);   //Changed here
  /**
 ...
 void ForwardTCMessage (olsr::MessageHeader olsrMessage,
                                 DuplicateTuple *duplicated,
                                 const Ipv4Address &localIface,
 ...
 void RemovalSingleTuple (const SingleHop* tuple);       //Changed here
  /**
