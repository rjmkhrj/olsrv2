...
protected:
  ...
  InterfaceSet m_interfaces;  //Changed here
  ProcessedSet m_processed;   //Changed here
  singhop m_neighset; //Changed here
  doublehop m_doubleset;  //Changed here
  allowed2hops m_twohops; //Changed here
  dxy m_dxy;  //Changed here
  rxm m_rxm;  //Changed here
  fmpr m_fmpr; //Changed here
  mfsp m_mfsp;  //Changed here
public:
  OlsrState ()
  {
  }
  ...
  void InsertRxmTuple (const Rxm &tuple);        //Changed here

  void InsertFloodingMPR (const FloodingMPR &tuple);  //Changed here

  FloodingMPR* FindFloodingMPR (const Ipv4Address &addr); //CHanged here
  // Neighbor

  void InsertFloodingMPRSelector (const MPRFloodingSelector &tuple); //Changed here
  /**
 ...
 mfsp & GetFloodingMPRselectors ()     //Changed here
  {
    return m_mfsp;
  }

  const singhop & GetNeighs () const  //Changed here
  {
     return m_neighset;
  }
  
  singhop & GetNeighs ()         //Changed here
  {
     return m_neighset;
  }

  const rxm & GetRxm () const      //Changed here
  {
     return m_rxm;
  }

  const fmpr & GetFMPR () const       //Changed here
  {
     return m_fmpr;
  }

  MPRFloodingSelector* FindMPRFloodingSelector  (const Ipv4Address &addr);  //Changed here
  /**
  ...
  bool FindNSymmetric (const NeighborTuple &tuple);                    //Changed here
  /**
  ...
  void InsertOneHopTuple (const SingleHop &tuple);   //Changed here
 
  void RemoveOneHopTuple (const Ipv4Address &mainAddr); //CHanged here

 SingleHop* FindSingleHopTuple (const Ipv4Address &mainAdd); //Changed here

 void InsertdxyTuple (const Comb &tuple);     //Changed here

 void InsertNtuple (const DoubleHopN &tuple);  //Changed here

 void InsertFloodingTuple (const FloodingMPR &tuple);  //Changed here

  void ChangeCorrespondingOutMetric (const Ipv4Address &t);
  /**
  ...
  allowed2hops & Getallowed2hops ()  //Changed here
  {
    return m_twohops;
  }
  /**
  ...
  InterfaceTuple* FindInterfaceTuple (const Ipv4Address &senderAddr, const uint16_t &seqNo, const MessageType &mg);   //Changed here

  void InsertInterfaceTuple (const InterfaceTuple &tuple); //Changed here
  
  ProcessedTuple* FindProcessedTuple (const Ipv4Address &senderAddr, const uint16_t &seqNo, const MessageType &mg);   //Changed here
   
  void InsertProcessedTuple (const ProcessedTuple &tuple);  //Changed here
};
